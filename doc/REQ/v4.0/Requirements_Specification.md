# DEXWEAVER MES v4.0 — 요구사항 정의서

> **버전**: v4.0 (REQ-001 ~ REQ-034, 총 34개)
> **작성일**: 2025-12-01
> **설명**: 초기 MES 시스템 요구사항 정의서

---

## 요구사항 목록 (REQ-001 ~ REQ-034)
...
| AI/ML | Prophet, XGBoost, SHAP, IsolationForest, OR-Tools |
| Infra | Kubernetes + Cilium eBPF |
